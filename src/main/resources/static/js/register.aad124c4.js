...
var $btnVCode = $('.row-vcode .btn-vcode');
var $inputPassword = $('.input-password');
var $inputVCode = $('.row-vcode .input-vcode');
var $hint = $('.login-form .hint');
var btnVCode = new _VCodeButton2['default']($btnVCode, $inputMobile, '/v3/user/sendRegCode', $('.row-captcha'));
...
btnVCode.on('send', hideErr);
btnVCode.on('error', showErr);
...
$btnSubmit.on('click', function () {
  ...
  (0, _fetch2['default'])({
    ...
    success: function success() {
      _progress.shared.showMessage('注册成功！');
      setTimeout(function () {
        location.href = _qs2['default'].redir ? _qs2['default'].redir : '/';
      }, 500);
    },
...
/******/ });
//# sourceMappingURL=//dn-piaoniu-static.qbox.me/pc/user/register.js.07cecf30.map